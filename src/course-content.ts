...
import { CoreCourseGetContentsWSResponse, CoreCourseGetContentsWSSection } from "./types/contents";
...
export type ScopedModule = { id: string; module: Module; course: SimpleCourse; sectionName: string };
